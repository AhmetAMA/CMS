...
<form action="" method="post" enctype="multipart/form-data">
    ...
    <div class="form-group">
        <img width="100" file="image" src="../images/<?php echo $post_image; ?>" alt="">
    ...
    <div class="form-group">
        ...
        <textarea class="form-control" name="post_content" id="30" rows="10"><?php echo $post_content; ?></textarea>
    </div>
